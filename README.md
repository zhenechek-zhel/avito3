...
- **dateTime** - поле, содержит время создания сообщения;
...
- **email** - поле хранящее Email-адрес магазина;
...
- **email** - уникальный Email-адрес пользователя;
...
```
Промежуточная сущность для реализации связи many-to-many Чата* с Участником*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Чата* с Сообщением*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Страны* с Городом*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Избранного* с Товаром*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Избранного* с Магазином*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Товара* с Категорией*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Товара* с Изображением*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Товара* с Отзывом*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Заказа* с Товаром*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Магазина* со Скидкой*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Магазина* с Товаром*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Магазина* с Отзывом*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Пользователя* с Корзиной*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Пользователя* со Скидкой*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Пользователя* с Заказом*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Пользователя* с Отзывом*.
```
...
```
Промежуточная сущность для реализации связи many-to-many Пользователя* с Ролью*.
```
...
```
Промежуточная сущность для реализации связи one-to-many Пользователя* с Магазином*.
```